...
New sessions are dropped by default if uftpd detects the FTP root is
...
> [!NOTE]
> Since v2.11 uftpd logs a lot more events by default.  Set up your
> syslogd to redirect `LOG_FTP` to a separate log file, or reduce the
> log level of uftpd using `-l error` to only log errors and higher.
...
[Release]:         https://github.com/troglobit/uftpd/releases
[Release Badge]:   https://img.shields.io/github/v/release/troglobit/uftpd
